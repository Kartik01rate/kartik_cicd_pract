...
System.setProperty("webdriver.chrome.driver","C:\\Users\\KARTIK'S\\git\\kartik_cicd_pract\\Drivers\\chromedriver.exe"); //mention dummy path or variable that stores chrome driver path 
